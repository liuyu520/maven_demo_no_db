 ...
 * 官方下载地址：http://commons.apache.org/proper/commons-codec/download_codec.cgi
 */
package com.kunlunsoft.wxcp.mp.aes;
...
public class WXBizMsgCrypt {
     ...
     */
    public WXBizMsgCrypt(String token, String encodingAesKey, String corpId, String thirdAppSuiteID) throws AesException {
    ...
    public String decrypt(String text) throws AesException {
        ...
        // corpid不相同的情况
        //from_corpid :wwab77ea1781b55566
        //corpId :ww92653858095c7bd4
        System.out.println("from_corpid :" + from_corpid);
        if (!from_corpid.equals(corpId)
                && (!from_corpid.equals(thirdAppSuiteID))) {
            System.out.println("corpId :" + corpId);
            log.warn("from_corpid :" + from_corpid);
